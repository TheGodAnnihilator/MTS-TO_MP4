# Let's also create a simple command-line version for users who prefer CLI
cli_converter_code = '''
#!/usr/bin/env python3
"""
...
# Save the CLI version
with open('mts_converter_cli.py', 'w', encoding='utf-8') as f:
    f.write(cli_converter_code)

print("Command-line version created successfully!")
print("Filename: mts_converter_cli.py")
print("\nCLI Features:")
print("- Single file or batch conversion")
print("- Progress tracking")
print("- Video information display")
print("- Quality settings control")
print("- Lossless copy option")
