# Let's create a comprehensive Python script for converting MTS to MP4 with GUI
# This script will handle large files, provide progress feedback, and preserve quality
...
with open('mts_to_mp4_converter.py', 'w', encoding='utf-8') as f:
    f.write(mts_converter_code)

print("MTS to MP4 Converter script has been created successfully!")
print("Filename: mts_to_mp4_converter.py")
print("\nFeatures included:")
print("- Interactive GUI with file dialogs")
print("- Progress bar with real-time updates")
print("- Quality settings (CRF and presets)")
print("- Lossless copy option for maximum quality")
